...
const char* serverName = "http://192.168.203.50:5000/sensor/german"; // Ganti dengan alamat server lokal Anda
...
String timestampStr = String(millis());
    ...
    String postData = "{\"Temperatur\":";
    postData += String(t);
    postData += ",\"Luftfeuchtigkeit\":";
    postData += String(h);
    postData += ",\"Zeitstempel\":";
